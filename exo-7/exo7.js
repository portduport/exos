...
function afficherOne() {
    ...
    jsonDatas.forEach(function (element) {
        ...
        if (translateType.hasOwnProperty(element.type)) {
            console.log(translateType[element.type]);
...
function productByType() {
    ...
    jsonDatas.forEach(function (elements) {
        if (inputType === elements.type) {
            elements.items.forEach(function (items) {
                if (checkBox.checked && items.quantity > 0) {
                    console.log(items.name);
                } else if (!checkBox.checked) {
                    console.log(items.name);
                }
